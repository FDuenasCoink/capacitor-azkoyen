...
public class CoinsChannels extends JSObject {
  ...
  public CoinsChannels() {
    super();
    channelsBits.put(50, new int[]{5, 15});
    channelsBits.put(100, new int[]{4, 14});
    channelsBits.put(200, new int[]{3, 13});
    channelsBits.put(500, new int[]{2, 10, 12});
    channelsBits.put(1000, new int[]{9, 11});
    reset();
  }
