...
public class SMClass {
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        AzkoyenControlJNI.delete_SMClass(swigCPtr);
      }
      swigCPtr = 0;
    }
  }
  ...
  static public class StateMachine_t {
    ...
    public synchronized void delete() {
      if (swigCPtr != 0) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          AzkoyenControlJNI.delete_SMClass_StateMachine_t(swigCPtr);
        }
        swigCPtr = 0;
      }
    }
    ...
    public void setCurrState(SMClass.State_t value) {
      AzkoyenControlJNI.SMClass_StateMachine_t_CurrState_set(swigCPtr, this, value.swigValue());
    }
  
    public SMClass.State_t getCurrState() {
      return SMClass.State_t.swigToEnum(AzkoyenControlJNI.SMClass_StateMachine_t_CurrState_get(swigCPtr, this));
    }
  
    public StateMachine_t() {
      this(AzkoyenControlJNI.new_SMClass_StateMachine_t(), true);
    }
  
  }

  public SMClass(AzkoyenClass _AzkoyenClass_p) {
    this(AzkoyenControlJNI.new_SMClass(AzkoyenClass.getCPtr(_AzkoyenClass_p), _AzkoyenClass_p), true);
  }

  public void setSM(SMClass.StateMachine_t value) {
    AzkoyenControlJNI.SMClass_SM_set(swigCPtr, this, SMClass.StateMachine_t.getCPtr(value), value);
  }

  public SMClass.StateMachine_t getSM() {
    long cPtr = AzkoyenControlJNI.SMClass_SM_get(swigCPtr, this);
    return (cPtr == 0) ? null : new SMClass.StateMachine_t(cPtr, false);
  }

  public void setLS(SMClass.StateMachine_t value) {
    AzkoyenControlJNI.SMClass_LS_set(swigCPtr, this, SMClass.StateMachine_t.getCPtr(value), value);
  }

  public SMClass.StateMachine_t getLS() {
    long cPtr = AzkoyenControlJNI.SMClass_LS_get(swigCPtr, this);
    return (cPtr == 0) ? null : new SMClass.StateMachine_t(cPtr, false);
  }

  public void setEvento(SMClass.Event_t value) {
    AzkoyenControlJNI.SMClass_Evento_set(swigCPtr, this, value.swigValue());
  }

  public SMClass.Event_t getEvento() {
    return SMClass.Event_t.swigToEnum(AzkoyenControlJNI.SMClass_Evento_get(swigCPtr, this));
  }

  public void setEstado(SMClass.State_t value) {
    AzkoyenControlJNI.SMClass_Estado_set(swigCPtr, this, value.swigValue());
  }

  public SMClass.State_t getEstado() {
    return SMClass.State_t.swigToEnum(AzkoyenControlJNI.SMClass_Estado_get(swigCPtr, this));
  }

  public void InitStateMachine() {
    AzkoyenControlJNI.SMClass_InitStateMachine(swigCPtr, this);
  }

  public int StateMachineRun(SMClass.Event_t Event) {
    return AzkoyenControlJNI.SMClass_StateMachineRun(swigCPtr, this, Event.swigValue());
  }

  public int RunCheck() {
    return AzkoyenControlJNI.SMClass_RunCheck(swigCPtr, this);
  }

  public int RunReset() {
    return AzkoyenControlJNI.SMClass_RunReset(swigCPtr, this);
  }

  public String StateMachineGetStateName(SMClass.State_t State) {
    return AzkoyenControlJNI.SMClass_StateMachineGetStateName(swigCPtr, this, State.swigValue());
  }
  ...
  public final static class State_t {
    ...
    public final static SMClass.State_t ST_WAIT_POLL = new SMClass.State_t("ST_WAIT_POLL");
    ...
    private static State_t[] swigValues = { ST_IDLE, ST_CONNECT, ST_CHECK, ST_WAIT_POLL, ST_POLLING, ST_RESET, ST_ERROR };
  ...
  public final static class Event_t {
    ...
    private static Event_t[] swigValues = { EV_ANY, EV_SUCCESS_CONN, EV_CALL_POLLING, EV_CHECK, EV_READY, EV_FINISH_POLL, EV_POLL, EV_LOOP, EV_ERROR };
    private static int swigNext = 0;
    private final int swigValue;
    private final String swigName;
  }
